...
const TABS = ['내 정보', '게시글', '팔로워', '팔로잉', '🎵 프로필 음악', '언어 설정']
  ...
  return (
    <main>
      <div className="container" style={{ maxWidth: '780px' }}>
        ...
        {tab === 5 && (
          <div className="card">
            <h3 style={{ fontFamily:'var(--serif)', marginBottom:'0.75rem', color:'var(--ink)' }}>🌐 언어 설정</h3>
            <p style={{ fontFamily:'var(--mono)', fontSize:'0.78rem', color:'var(--muted)', marginBottom:'1.25rem' }}>
              사용할 언어를 선택해주세요. 선택 즉시 적용됩니다.
            </p>
            ...
            <p style={{ fontFamily:'var(--mono)', fontSize:'0.72rem', color:'var(--muted)', marginTop:'1rem' }}>
              현재 언어: <strong style={{ color:'var(--accent)' }}>{lang === 'ko' ? '🇰🇷 한국어' : '🇺🇸 English'}</strong>
            </p>
          </div>
        )}
